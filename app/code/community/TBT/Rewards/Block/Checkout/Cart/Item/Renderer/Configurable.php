 ...
 */
class TBT_Rewards_Block_Checkout_Cart_Item_Renderer_Configurable extends TBT_Rewards_Block_Checkout_Cart_Item_Renderer {
	...
	public function getProductAttributes() {
		$attributes = $this->getProduct ()->getTypeInstance ( true )->getSelectedAttributesInfo ( $this->getProduct () );
		return $attributes;
	}
