 ...
 */
class TBT_Rewards_Block_Manage_Catalog_Product_Edit_Tab_Distribution extends Mage_Adminhtml_Block_Widget_Grid implements Mage_Adminhtml_Block_Widget_Tab_Interface {
...
'url' => array ('base' => 'rewardsadmin/manage_promo_catalog/' . 'edit/type/1' ), 'field' => 'id' ) ), 'filter' => false, 'sortable' => false, 'index' => 'stores', 'is_system' => true ) );
	...
	public function getGridUrl() {
		return $this->getUrl ( 'rewardsadmin/manage_catalog_product_edit/dRulesGrid', array ('product_id' => $this->getProductId (), '_current' => true ) ); //array('id' => $this->_getTransfer()->getId()
	}
