 ...
 */
class TBT_RewardsOnly_Model_Catalogrule_Selection_Algorithm_First
	extends TBT_RewardsOnly_Model_Catalogrule_Selection_Algorithm_Zeroabstract
{	
	/**
	...
	public function getRule() {
		foreach($this->getRules() as $rule) {
			$matched_rule = TBT_RewardsOnly_Model_Catalogrule_Rule::wrap($rule);
			return $matched_rule;
		}
		return null;
	}
