...
/**
 * The Sweet Tooth (Rewards) salesrule/rule resource model must be rewritten so that the
 * Instore salesrule/rule collection will be used instead, to filter out all Instore cart rules.
 *
 * @category   TBT
 * @package    TBT_Rewardsinstore
