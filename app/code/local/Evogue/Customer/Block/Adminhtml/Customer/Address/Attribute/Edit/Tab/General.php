<?php
class Evogue_Customer_Block_Adminhtml_Customer_Address_Attribute_Edit_Tab_General
    ...
    protected function _prepareForm() {
        ...
        Mage::dispatchEvent('evogue_customer_address_attribute_edit_tab_general_prepare_form', array(
            'form'      => $form,
            'attribute' => $attribute
        ));
