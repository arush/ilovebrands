...
class FME_Manufacturers_Block_Adminhtml_Manufacturers_Edit_Tab_Products extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        parent::__construct();
        $this->setId('manufacturer_products_grid');
    ...
    {
        return Mage::registry('current_manufacturer_products');
    }
