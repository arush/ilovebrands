...
class Evolved_Like_Model_System_Config_Source_Color
{

    public function toOptionArray()
    {
        return array(
            array('value'=>Mage::helper('evlike')->__('light'), 'label'=>Mage::helper('evlike')->__('light')),
            array('value'=>Mage::helper('evlike')->__('dark'), 'label'=>Mage::helper('evlike')->__('dark')),
        );
    }
