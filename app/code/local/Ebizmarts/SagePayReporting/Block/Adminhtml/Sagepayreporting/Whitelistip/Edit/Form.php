...
class Ebizmarts_SagePayReporting_Block_Adminhtml_Sagepayreporting_Whitelistip_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
	...
	protected function _prepareForm()
	{
		...
		$fieldset->addField('ip_mask', 'text',
		array(
                'name'  => 'ip_mask',
		...
		$fieldset->addField('ip_note', 'text',
		array(
                'name'  => 'ip_note',
		...
		$fieldset->addField('mode', 'multiselect',
		array(
                'name'  => 'mode',
		...
		$fieldset->addField('api_password', 'password',
		array(
                'name'  => 'api_password',
