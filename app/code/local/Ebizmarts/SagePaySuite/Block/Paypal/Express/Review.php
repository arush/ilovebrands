 ...
 */
class Ebizmarts_SagePaySuite_Block_Paypal_Express_Review extends Mage_Core_Block_Template
{
    /**
    ...
    protected function _beforeToHtml()
    {
        ...
        $this->setPaymentMethodTitle($methodInstance->getPayPalTitle());
        ...
        $this->setEditUrl($this->getUrl('checkout/cart'))
            ->setPlaceOrderUrl($this->getUrl( "{$this->_paypalActionPrefix}/paypalexpress/placeOrder", array('_secure'=>true) ));
