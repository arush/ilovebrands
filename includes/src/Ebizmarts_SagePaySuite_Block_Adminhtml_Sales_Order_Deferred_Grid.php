...
class Ebizmarts_SagePaySuite_Block_Adminhtml_Sales_Order_Deferred_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        if (!Mage::app()->isSingleStoreMode()) {
            $this->addColumn('store_id', array(
                'header'    => Mage::helper('sagepaysuite')->__('Purchased from (store)'),
                'index'     => 'store_id',
                'type'      => 'store',
                'store_view'=> true,
        ...
        $this->addColumn('created_at', array(
            'header' => Mage::helper('sagepaysuite')->__('Purchased On'),
            'index' => 'created_at',
            'type' => 'datetime',
            'width' => '100px',
        ));
        ...
        $this->addColumn('billing_name', array(
            'header' => Mage::helper('sagepaysuite')->__('Bill to Name'),
            'index' => 'billing_name',
        ));

        $this->addColumn('shipping_name', array(
            'header' => Mage::helper('sagepaysuite')->__('Ship to Name'),
            'index' => 'shipping_name',
        ));

        $this->addColumn('base_grand_total', array(
            'header' => Mage::helper('sagepaysuite')->__('G.T. (Base)'),
        ...
        $this->addColumn('grand_total', array(
            'header' => Mage::helper('sagepaysuite')->__('G.T. (Purchased)'),
            'index' => 'grand_total',
            'type'  => 'currency',
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('release_order', array(
