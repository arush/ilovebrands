...
class Mage_Catalog_Block_Navigation extends Mage_Core_Block_Template
{
        ...
        $isOutermost = false, $outermostItemClass = '', $childrenWrapClass = '', $noEventAttributes = false)
    {
		...
		//FLO EDIT
		$category1_clickable = Mage::getStoreConfig('timer/view/category_anchor1');
		$category2_clickable = Mage::getStoreConfig('timer/view/category_anchor2');
		
		if((int)$category->getId() === (int)$category1_clickable || (int)$category->getId() === (int)$category2_clickable) {
			$category_clickable = true;
		}
		else {
			$category_clickable = false;
		}
        ...
        else if ($hasActiveChildren && $level === 0 && $category_clickable === false) {
