...
class Evolved_Like_Model_System_Config_Source_Verb
{

    public function toOptionArray()
    {
        return array(
            array('value'=>Mage::helper('evlike')->__('like'), 'label'=>Mage::helper('evlike')->__('like')),
            array('value'=>Mage::helper('evlike')->__('recommend'), 'label'=>Mage::helper('evlike')->__('recommend')),
        );
    }
