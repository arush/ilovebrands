 ...
 * matches the product and creates an effect on the product that 
 * brings the product price to $0;
 *
 * @category   TBT
 * @package    TBT_Rewards
 * @author     WDCA Sweet Tooth Team <contact@wdca.ca>
 */
class TBT_RewardsPlat_Model_Catalogrule_Selection_Algorithm_First
	extends TBT_RewardsPlat_Model_Catalogrule_Selection_Algorithm_Zeroabstract
{	
	/**
	...
	public function getRule() {
		foreach($this->getRules() as $rule) {
			$matched_rule = TBT_RewardsPlat_Model_Catalogrule_Rule::wrap($rule);
			return $matched_rule;
		}
		return null;
	}
