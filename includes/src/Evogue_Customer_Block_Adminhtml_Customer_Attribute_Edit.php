<?php
class Evogue_Customer_Block_Adminhtml_Customer_Attribute_Edit
    ...
    public function getHeaderText() {
        if ($this->_getAttribute()->getId()) {
            ...
            return Mage::helper('evogue_customer')->__('Edit Customer Attribute "%s"', $label);
        } else {
            return Mage::helper('evogue_customer')->__('New Customer Attribute');
        }
    }
