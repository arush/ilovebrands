...
/**
 * Shutl Export Stock Level Button
 *
 * @category   Pod1
 * @package    Pod1_Shutl
...
class Pod1_Shutl_Block_System_Config_Form_Field_Exportstocklevel extends Mage_Adminhtml_Block_System_Config_Form_Field {
	protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element) {
        ...
        $data = array(
            ...
            'onclick'   => 'setLocation(\''.$this->getUrl("shutl/export/stocklevel") .'\')',
            'class'     => '',
        );
