 ...
 */
class TBT_Rewards_Block_System_Html extends Mage_Adminhtml_Block_System_Config_Form_Fieldset {
	...
	public function render(Varien_Data_Form_Element_Abstract $element) {
		...
		$html .= "
            ...
            Sweet Tooth v" . Mage::getConfig ()->getNode ( 'modules/TBT_Rewards/version' ) . ". <a href='http://www.getsweettooth.com/news' target='_blank'>Click here for updates.</a><BR /> 
		";
