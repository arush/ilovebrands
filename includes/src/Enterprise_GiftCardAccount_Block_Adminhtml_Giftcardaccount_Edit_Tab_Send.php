...
*/
        ...
        $fieldset->addField('store_id', 'select', array(
            ...
            'label'    => Mage::helper('evogue_customerbalance')->__('Send Email from the Following Store View'),
            'title'    => Mage::helper('evogue_customerbalance')->__('Send Email from the Following Store View'),
