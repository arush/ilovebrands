...
class TBT_Rewards_Model_Test_Suite_Rewards_Database_Tables extends TBT_Testsweet_Model_Test_Suite_Abstract {
    ...
    public function getDescription() {
        return $this->__('Check database for required Sweet Tooth tables and columns.');
    }
    ...
    protected function generateSummary() {
        ...
        if (!empty($_REQUEST['debug'])) {
            ...
            $msg .= "Current Sweet Tooth Core Database schema:\n";
