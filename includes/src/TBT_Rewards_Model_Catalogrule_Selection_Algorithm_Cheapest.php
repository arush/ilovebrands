 ...
 */
class TBT_Rewards_Model_Catalogrule_Selection_Algorithm_Cheapest extends TBT_Rewards_Model_Catalogrule_Selection_Algorithm_Abstract {
	/**
	...
	/* (non-PHPdoc)
	 * @see TBT_Rewards_Model_Catalogrule_Selection_Algorithm_Abstract::isRuleValid()
	 */
