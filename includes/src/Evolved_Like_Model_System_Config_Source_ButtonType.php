...
class Evolved_Like_Model_System_Config_Source_ButtonType
{

    public function toOptionArray()
    {
        return array(
            array('value'=>1, 'label'=>Mage::helper('evlike')->__('iFrame')),
            array('value'=>0, 'label'=>Mage::helper('evlike')->__('XFBML')),
        );
    }
