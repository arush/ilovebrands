...
class Evolved_Like_Model_System_Config_Source_Font
{

    public function toOptionArray()
    {
        return array(
            array('value'=>Mage::helper('evlike')->__('arial'), 'label'=>Mage::helper('evlike')->__('arial')),
            array('value'=>Mage::helper('evlike')->__('lucida grande'), 'label'=>Mage::helper('evlike')->__('lucida grande')),
			array('value'=>Mage::helper('evlike')->__('segoe ui'), 'label'=>Mage::helper('evlike')->__('segoe ui')),
			array('value'=>Mage::helper('evlike')->__('tahoma'), 'label'=>Mage::helper('evlike')->__('tahoma')),
			array('value'=>Mage::helper('evlike')->__('trebuchet ms'), 'label'=>Mage::helper('evlike')->__('trebuchet ms')),
			array('value'=>Mage::helper('evlike')->__('verdana'), 'label'=>Mage::helper('evlike')->__('verdana'))
        );
    }
